...
// display stats... exactly what the method says it does...
...
void Player::doAction(char action, int time)
{
	...
	else if(locationName.compare("Dorm") == 0)
	{
		...
		{
			cout << "You break out the books and work through some problems.\n";
	...
	cout << "Your actions changed your stats by... ";
