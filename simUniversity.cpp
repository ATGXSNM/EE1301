...
int main()
{
	...
	while(!gameOver)
	{
		...
		if(player.getSmartness() >= 100)
		{
			cout<<"you win the game and graduate collage! Congratulations!";
			return 0;
		}
...
bool updatePlayer()
{
	...
	{
		cout << "Your life is sapped of color and you become a mindless cog in the societal machine.\n";
		gameOver = true;
	}
	// dum dum dummmm!
	else if(player.getSmartness() == 0)
	{
		cout << "You drop out of college and pursue a career in holding signs.\n";
		gameOver = true;
	}
